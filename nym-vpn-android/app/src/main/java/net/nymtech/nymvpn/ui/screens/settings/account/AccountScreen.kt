    ...
    Column(
        ...
        Box(
            ...
            Column(
                ...
                val daysLeft = buildAnnotatedString {
        ...
        Column(
            ...
            SurfaceSelectionGroupButton(
                items = uiState.devices.map {
                    SelectionItem(
                        ImageVector.vectorResource(it.type.icon()), trailing = {
                            IconButton(onClick = { /*TODO handle item delete from authorized*/ }) {
