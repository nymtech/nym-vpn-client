...
class DynamicShortcutManager(val context: Context) : ShortcutManager {
	...
	private fun createShortcuts(): List<ShortcutInfoCompat> = listOf(
		buildShortcut(
	...
	@RequiresApi(Build.VERSION_CODES.N_MR1)
	private fun buildShortcut(id: String, shortLabel: String, longLabel: String, intent: Intent, shortcutIcon: Int): ShortcutInfoCompat = ShortcutInfoCompat.Builder(context, id)
