...
data class MixnetConnectionState(val ipv6State: ConnectionEvent = ConnectionEvent.ENTRY_GATEWAY_DOWN, val ipv4State: ConnectionEvent = ConnectionEvent.ENTRY_GATEWAY_DOWN) {
	fun onEvent(connectionEvent: ConnectionEvent): MixnetConnectionState = when (connectionEvent) {
