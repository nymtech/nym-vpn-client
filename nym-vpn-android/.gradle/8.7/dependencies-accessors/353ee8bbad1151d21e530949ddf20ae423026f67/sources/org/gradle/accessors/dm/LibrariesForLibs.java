...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxWindowLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final AndroidxWindowCoreLibraryAccessors laccForAndroidxWindowCoreLibraryAccessors = new AndroidxWindowCoreLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.window.core</b>
         */
        public AndroidxWindowCoreLibraryAccessors getCore() {
            return laccForAndroidxWindowCoreLibraryAccessors;
        }

    }

    public static class AndroidxWindowCoreLibraryAccessors extends SubDependencyFactory {

        public AndroidxWindowCoreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>androidx.window:window-core-android</b> coordinates and
         * with version reference <b>windowCoreAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("androidx.window.core.android");
        }
    ...
    public static class ComAndroidToolsLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getDesugar() {
            return create("com.android.tools.desugar");
        }
    ...
    public static class DetektLibraryAccessors extends SubDependencyFactory {
        private final DetektRulesLibraryAccessors laccForDetektRulesLibraryAccessors = new DetektRulesLibraryAccessors(owner);

        public DetektLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>detekt.rules</b>
         */
        public DetektRulesLibraryAccessors getRules() {
            return laccForDetektRulesLibraryAccessors;
        }

    }

    public static class DetektRulesLibraryAccessors extends SubDependencyFactory {

        public DetektRulesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compose</b> with <b>ru.kode:detekt-rules-compose</b> coordinates and
         * with version reference <b>detektRulesCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("detekt.rules.compose");
        }
    ...
    public static class JavaLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>client</b> with <b>io.appium:java-client</b> coordinates and
         * with version reference <b>javaClient</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getClient() {
            return create("java.client");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>detektRulesCompose</b> with value <b>1.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDetektRulesCompose() { return getVersion("detektRulesCompose"); }
        ...
        /**
         * Version alias <b>javaClient</b> with value <b>9.2.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJavaClient() { return getVersion("javaClient"); }

        /**
         * Version alias <b>jna</b> with value <b>5.14.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>materialIconsExtended</b> with value <b>1.6.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>window</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>windowCoreAndroid</b> with value <b>1.3.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getWindowCoreAndroid() { return getVersion("windowCoreAndroid"); }
        ...
        /**
         * Group of versions at <b>versions.gradlePlugins</b>
         */
    ...
    public static class GradlePluginsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>gradlePlugins.detekt</b> with value <b>1.23.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDetekt() { return getVersion("gradlePlugins.detekt"); }

        /**
         * Version alias <b>gradlePlugins.gross</b> with value <b>0.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGross() { return getVersion("gradlePlugins.gross"); }

        /**
         * Version alias <b>gradlePlugins.kotlinxSerialization</b> with value <b>1.9.23</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinxSerialization() { return getVersion("gradlePlugins.kotlinxSerialization"); }

        /**
         * Version alias <b>gradlePlugins.ktlint</b> with value <b>12.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKtlint() { return getVersion("gradlePlugins.ktlint"); }

        /**
         * Version alias <b>gradlePlugins.licensee</b> with value <b>1.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLicensee() { return getVersion("gradlePlugins.licensee"); }

        /**
         * Version alias <b>gradlePlugins.sentry</b> with value <b>4.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSentry() { return getVersion("gradlePlugins.sentry"); }
    ...
    public static class PluginAccessors extends PluginFactory {
         ...
         * with version reference <b>gradlePlugins.detekt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Plugin provider for <b>gross</b> with plugin id <b>se.premex.gross</b> and
         * with version reference <b>gradlePlugins.gross</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getGross() { return createPlugin("gross"); }
         ...
         * with version reference <b>gradlePlugins.kotlinxSerialization</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
         ...
         * with version reference <b>gradlePlugins.ktlint</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Plugin provider for <b>licensee</b> with plugin id <b>app.cash.licensee</b> and
         * with version reference <b>gradlePlugins.licensee</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getLicensee() { return createPlugin("licensee"); }

        /**
         * Plugin provider for <b>sentry</b> with plugin id <b>io.sentry.android.gradle</b> and
         * with version reference <b>gradlePlugins.sentry</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
