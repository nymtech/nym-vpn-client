...
import nym_vpn_lib_types.Profile
...
sealed class CoreVpnConfigUpdate {
	...
	data class SetProfile(val value: Profile) : CoreVpnConfigUpdate()
	data class SetEnableGeoLocation(val value: Boolean) : CoreVpnConfigUpdate()
