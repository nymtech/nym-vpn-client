...
// Must stay at file level: preferencesDataStore is only a singleton per delegate
// instance, and the service recreates this store on every onCreate. An instance-level
// delegate creates a second DataStore on the same file, which throws IllegalStateException.
