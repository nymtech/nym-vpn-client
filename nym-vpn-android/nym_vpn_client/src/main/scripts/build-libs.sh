...
(cd $PWD/../../nym-vpn-core/nym-vpn-lib; cargo ndk -t arm64-v8a -o ../../nym-vpn-android/nym_vpn_client/src/main/jniLibs build --release)
#mv wireguard
...
(cd $PWD/../../nym-vpn-core; cargo run --bin uniffi-bindgen generate --library ./target/aarch64-linux-android/release/libnym_vpn_lib.so  --language kotlin --out-dir ../nym-vpn-android/nym_vpn_client/src/main/java/net/nymtech/vpn -n)
#fix package name
