...
public enum NymSpacing {
    ...
    /// 350 pt — standard button / card width
    public static let contentWidth: CGFloat = 350
    /// 320 pt — minimum content width
    public static let minContentWidth: CGFloat = 320
