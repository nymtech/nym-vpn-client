...
/// Nym 2.0 feature-overview onboarding carousel.
///
/// A full-screen, swipeable set of introductory screens (see Figma node
/// 4440-20189) with a persistent bottom card — Nym wordmark, tagline and a
/// single "Get started" call-to-action that hands off to the auth flow.
