...
function Login() {
  ...
  return (
    <PageAnim className="h-full flex flex-col justify-end items-center gap-6 select-none cursor-default" data-testid="login-page">
      <div className="grow w-full" />
      <div className="flex flex-col items-center gap-4 px-4">
        <h1 className="text-2xl dark:text-white" data-testid="login-welcome-text">{t('welcome')}</h1>
        <h2 className="text-center text-iron dark:text-bombay w-11/12" data-testid="login-description">
          {t('description')}
        </h2>
      </div>
      <div className="w-full grow flex flex-col justify-end gap-3">
        ...
        <div className="w-full flex flex-col justify-center items-center gap-6 mb-2">
          ...
          <div className="flex flex-row justify-center items-center gap-2" data-testid="login-create-account-section">
            <span className="dark:text-white truncate" data-testid="login-create-account-text">
