...
import (
	...
	"github.com/mullvad/mullvadvpn-app/wireguard/libwg/container"
	"github.com/mullvad/mullvadvpn-app/wireguard/libwg/logging"
	"github.com/mullvad/mullvadvpn-app/wireguard/libwg/udp_forwarder"
...
//export wgNetDisableSomeRoamingForBrokenMobileSemantics
func wgNetDisableSomeRoamingForBrokenMobileSemantics(tunnelHandle int32) {
	dev, err := netTunnelHandles.Get(tunnelHandle)
	if err != nil {
		return
	}
