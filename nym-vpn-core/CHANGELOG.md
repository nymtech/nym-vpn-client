...
- Only select gateways with >= 75% performance, unless the gateway with lower performance is selected explicitly (https://github.com/nymtech/nym-vpn-client/pull/3511)
