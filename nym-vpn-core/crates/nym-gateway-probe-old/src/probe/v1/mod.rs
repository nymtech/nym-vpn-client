...
use nym_bin_common_v1::bin_info_local_vergen;
use nym_client_core_v1::config::DebugConfig;
use nym_connection_monitor_v1::self_ping_and_wait;
use nym_gateway_directory_v1::{
    Config as GatewayDirectoryConfig, EntryPoint, GatewayClient as GatewayDirectoryClient,
    GatewayList, IpPacketRouterAddress,
};
use nym_ip_packet_client_v1::{IprClientConnect, SharedMixnetClient};
use nym_ip_packet_requests_v1::{
