...
#[cfg(target_os = "linux")]
pub(crate) const MULLVAD_SYSTEMD_OVERRIDE_FILE: &str =
...
/// Enable the Mullvad VPN system service startup. This will configure the service to start
...
#[cfg(target_os = "linux")]
pub async fn get_daemon_environment(systemd_override_file: &str) -> Result<HashMap<String, String>, test_rpc::Error> {
