...
use test_rpc::{
    ...
    meta::OsVersion,
    mullvad_daemon::{MULLVAD_SOCKET_PATH, NYMVPN_SOCKET_PATH, ServiceStatus},
    net::SockHandleId,
    package::Package,
...
impl Service for TestServer {
    ...
    async fn set_daemon_log_level(
        ...
        sys::set_daemon_log_level(
            verbosity_level,
            "mullvad-daemon",
            sys::MULLVAD_SYSTEMD_OVERRIDE_FILE,
        )
        .await
    }
    ...
    async fn set_daemon_environment(
        ...
        sys::set_daemon_environment(env, "mullvad-daemon", sys::MULLVAD_SYSTEMD_OVERRIDE_FILE).await
    }
    ...
    async fn get_daemon_environment(
        ...
        sys::get_daemon_environment(sys::MULLVAD_SYSTEMD_OVERRIDE_FILE).await
    }
