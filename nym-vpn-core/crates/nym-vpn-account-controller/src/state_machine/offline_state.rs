        ...
        tokio::select! {
            Some(command) = command_rx.recv() => {
                ...
                match command {
                    ...
                    AccountCommand::ForgetAccount(return_sender, _) => return_no_connectivity(return_sender),
                    ...
                    AccountCommand::Common(common_command) => {
                        match common_command {
                            ...
                            CommonCommand::GetCurrentAccountMode(return_sender) => return_sender.send(common_handler::handle_get_current_account_mode(shared_state).await),
