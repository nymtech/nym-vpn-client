...
pub(super) const DEFAULT_MNEMONIC: &str =
...
pub(super) const DEFAULT_MNEMONIC_ID: &str = "n1sslaag27wfydyrvyua72hg5e0vteglxrs8nw3c";

// The default device mnemonic, the same as in the js integration tests
pub(super) const DEFAULT_DEVICE_MNEMONIC: &str =
...
pub(super) const DEFAULT_DEVICE_IDENTITY_KEY: &str = "FJDUECYAeosXhNGjxf8w5MJM7N2DfDwQznvWwTxJz6ft";
