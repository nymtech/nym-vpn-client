...
pub async fn set_poisson_parameter(&mut self, value: f32) -> Result<()> {
    ...
    pub async fn set_average_packet_delay(&mut self, delay_ms: f32) -> Result<()> {
        let request = proto::SetAveragePacketDelayRequest {
            delay_ms,
        };
    ...
    pub async fn set_message_sending_average_delay(&mut self, delay_ms: f32) -> Result<()> {
        let request = proto::SetMessageSendingAverageDelayRequest {
            delay_ms,
        };
