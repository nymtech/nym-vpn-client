...
use crate::{
    ...
    ActionAfterDisconnect as ProtoActionAfterDisconnect, Address as ProtoAddress,
    ConnectionData as ProtoConnectionData, ErrorStateReason as ProtoErrorStateReason,
    Gateway as ProtoGateway, MixnetConnectionData as ProtoMixnetConnectionData,
