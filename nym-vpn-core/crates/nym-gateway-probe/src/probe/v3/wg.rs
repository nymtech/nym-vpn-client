...
use nym_authenticator_client_magura::{
    AuthClient, ClientMessage, SharedMixnetClient as AuthSharedMixnetClient,
};
use nym_authenticator_requests_magura::v3::{
...
use nym_crypto_magura::asymmetric::encryption::PrivateKey;
use nym_gateway_directory_magura::AuthAddress;
use nym_sdk_magura::mixnet::MixnetClient;
use nym_topology_magura::NetworkAddress;
use nym_wireguard_types_magura::PeerPublicKey;
