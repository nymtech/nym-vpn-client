...
use nym_bin_common_magura::bin_info_local_vergen;
use nym_client_core_magura::config::DebugConfig;
use nym_connection_monitor_magura::self_ping_and_wait;
use nym_gateway_directory_magura::{
    Config as GatewayDirectoryConfig, EntryPoint, GatewayClient as GatewayDirectoryClient,
    GatewayList, IpPacketRouterAddress,
};
use nym_ip_packet_client_magura::{IprClientConnect, SharedMixnetClient};
use nym_ip_packet_requests_magura::{
