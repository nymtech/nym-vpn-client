...
impl ConnectingState {
    ...
    async fn handle_resolved_gateway_config(
        ...
        shared_state.resolved_api_endpoints = resolved_gateway_config.all_socket_addrs();

        self.firewall_policy_params.api_endpoints = shared_state.resolved_api_endpoints.clone();
