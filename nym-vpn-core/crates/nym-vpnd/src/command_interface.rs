...
async fn set_poisson_parameter(
    ...
    let _ = self
        ...
        .await
        .map_err(|e| tonic::Status::internal(format!("Failed to set Poisson parameter: {e}")))?;
    ...
    async fn set_average_packet_delay(
        ...
        let _ = self
            ...
            .await
            .map_err(|e| tonic::Status::internal(format!("Failed to set average packet delay: {e}")))?;
...
async fn set_disable_poisson_rate(
    ...
    self.send_and_wait(VpnServiceCommand::SetDisablePoissonRate, disable_poisson_rate)
        .await
    ...
    async fn set_message_sending_average_delay(
        ...
        let _ = self
            ...
            .map_err(|e| tonic::Status::internal(format!(
                "Failed to set message sending average delay: {e}"
            )))?;
